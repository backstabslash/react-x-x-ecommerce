...
function Header() {
  ...
  return mobileNav ? (
    <div className={`mobile-nav ${mobileNav ? 'mobile-nav-flex' : 'mobile-nav-none'}`}>
      <nav>
        ...
        <div className="mobile-nav__utils">
          <button className="mobile-nav__bars" onClick={() => setMobileNav(!mobileNav)}>
    ...
    <header className={`header container ${headerFixed ? 'header__fixed' : ''}`}>
      <div className="header__wrapper">
        ...
        <nav>
          <ul className="header__menu">
            <li>
              <Link className="header__link" to="/categories" onClick={() => window.top(0, 0)}>
                Categories
              </Link>
            </li>
            <li>
              <Link className="header__link" to="/product/1" onClick={() => window.top(0, 0)}>
                Product
              </Link>
            </li>
            ...
            <li>
              <button
                ...
                className={`header__cart ${cartItemsLength > 0 ? 'header__cart-with-items' : ''}`}
                onClick={cartToggle}
              >
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="header__mobile-nav">
            ...
            <button className="header__bars" onClick={() => setMobileNav(!mobileNav)}>
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor">
                <path
                  fillRule="evenodd"
                  d="M3 6.75A.75.75 0 013.75 6h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 6.75zM3 12a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75A.75.75 0 013 12zm0 5.25a.75.75 0 01.75-.75h16.5a.75.75 0 010 1.5H3.75a.75.75 0 01-.75-.75z"
